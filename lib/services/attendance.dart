          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                user.startaddress.isEmpty?SizedBox(): Container(
                  width: MediaQuery.of(context).size.width-40,
                  child: Text.rich(
                    TextSpan(
                      children: [
                        TextSpan(
                          text: "Check in Address : ", // First word in red
                          style: TextStyle(
                            color: Colors.red,
                        ...
                        TextSpan(
                          text: " ${user.startaddress}", // Rest in black
                          style: TextStyle(
                            color: Colors.black,
                            fontWeight: FontWeight.w500,
                            fontSize: 10,
                ...
                user.endaddress.isEmpty?SizedBox(): Container(
                  width: MediaQuery.of(context).size.width-40,
                  child: Text.rich(
                    TextSpan(
                      children: [
                        TextSpan(
                          text: "Check out Address : ", // First word in red
                          style: TextStyle(
                            color: Colors.red,
                            fontWeight: FontWeight.w500,
                            fontSize: 10,
                        ...
                        TextSpan(
                          text: " ${user.endaddress}", // Rest in black
                          style: TextStyle(
                            color: Colors.black,
                            fontWeight: FontWeight.w500,
                            fontSize: 10,
