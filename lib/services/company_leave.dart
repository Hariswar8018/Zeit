...
DateTime ti=DateTime.now();
              ...
              Row(
                ...
                children: [
                  InkWell(
                    onTap: () async {
                      if(cv.text.isEmpty){
                        Send.message(context, "Please specify Reason before selecting Holiday", false);
                      }else{
                    ...
                    child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: cv.text.isEmpty?Colors.grey:Colors.blue,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Center(child: Text("Add 1 day Holiday",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700),)),
                        )
                    ),
                  ),
                  _buildCalendarDialogButton(w),
                ],
              ),
              InkWell(
                onTap: () async {
                  if(!range &&on&&cv.text.isNotEmpty){
                    try {
                    ...
                    print(_singleDatePickerValueWithDefaultValue.length);
                    Send.message(context, "Select Date / Range First", false);
                  }
                },
                child: Padding(
                  ...
                  child: Container(
                    ...
                    height: 40,
                    decoration: BoxDecoration(
                      color:!on ?Colors.grey:Colors.blue,
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: Center(
  ...
  _buildCalendarDialogButton(double w) {
    const dayTextStyle =  TextStyle(color: Colors.black, fontWeight: FontWeight.w700);
    final weekendTextStyle =
    TextStyle(color: Colors.grey[500], fontWeight: FontWeight.w600);
    final anniversaryTextStyle = TextStyle(
