...
class _JobUhjState extends State<JobUhj> {
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Center(child: Icon(Icons.share_arrival_time_rounded,size: 12,)),
                    SizedBox(width: 8,),
                    Center(child: Text(" Created on " +timeAgoFromMilliseconds(widget.user.id),style: TextStyle(fontWeight: FontWeight.w400,fontSize: 8,),)),
                  ],
                ),
              ),
              SizedBox(height: 3,),
  ...
  String timeAgoFromMilliseconds(String millisString) {
    try {
      ...
      DateTime givenDate = DateTime.fromMicrosecondsSinceEpoch(millis);  // Use milliseconds
      DateTime now = DateTime.now();
      String formattedTime = DateFormat('HH:mm on dd/MM/yy').format(givenDate);
        ...
        Padding(
          ...
          child: SocialLoginButton(
              ...
              onPressed: () async {
                ...
                Note u=Note(id: d, title: name.text, description: link.text, idd: '');
                await  FirebaseFirestore.instance
