...
import 'package:zeitt/organisation/all_users.dart';
import 'package:zeitt/superadmin/add_company.dart';
import 'package:zeitt/superadmin/view_company.dart';
              ...
              InkWell(
                  onTap: (){
                    Navigator.push(
                        context,
                        PageTransition(
                            child: AddCompany1(strr: '',),
                            type: PageTransitionType.bottomToTop,
                            duration: Duration(milliseconds: 300)));
                  },
                  child: q(context, "assets/transaction-finance-business-svgrepo-com.svg", "Add Organisation")),
              InkWell(
                  onTap: (){
                    Navigator.push(
                        context,
