...
import 'package:zeit/organisation/info.dart';
      ...
      body:Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(textAlign:TextAlign.center,
              "You need to attach yourself to Organisation or create a new one if Organisation don't exist in Zeit.",
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),
            ),
          ),
          ElevatedButton(onPressed: (){
          ...
          }, child: Text("My Zeit ID to share")),
          SizedBox(height: 5),
